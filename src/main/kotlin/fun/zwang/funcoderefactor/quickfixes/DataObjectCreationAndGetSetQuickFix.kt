...
class DataObjectCreationAndGetSetQuickFix : LocalQuickFix {
    ...
    fun applyFix(project: Project, element: PsiElement) {
        ...
        val className = ExpressionUtils.extractClassNameFromDataObjectCreationStatement(initializer) ?: return
        ...
        for (reference in references) {
            ...
            if (methodCallExpression != null && ExpressionUtils.isDataObjectGetterOrSetter(
        ...
        creationQuickFix.applyFix(project, element)
    }
}
